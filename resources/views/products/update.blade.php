...
<head>
    ...
    <link rel="stylesheet" href={{URL::asset('assets/css/update.css')}}>
    <title>Update</title>
</head>
...
<body>
    ...
    <main>
        <form action="{{route('products.update',$product->id)}}" method="post">
            ...
            <input type="text" name="description" id="description" placeholder="Descrição do Produto" value="{{$product->description}}">
